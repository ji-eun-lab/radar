...
def main(args):
    ...
    # 변경된 데이터셋 사용
    train_dataset = H5PointCloudDataset(h5_path=data_path, split='train', num_points=args.num_point)
    test_dataset = H5PointCloudDataset(h5_path=data_path, split='test', num_points=args.num_point)
